...
const CornerBorders = () => (
  <>
    <div className="dark:border-zinc-700 border-zinc-100 size-6 absolute top-0 left-0 border-l-2 border-t-2 rounded-tl-md" />
    <div className="dark:border-zinc-700 border-zinc-100 size-6 absolute top-0 right-0 border-r-2 border-t-2 rounded-tr-md" />
    <div className="dark:border-zinc-700 border-zinc-100 size-6 absolute bottom-0 left-0 border-l-2 border-b-2 rounded-bl-md" />
    <div className="dark:border-zinc-700 border-zinc-100 size-6 absolute bottom-0 right-0 border-r-2 border-b-2 rounded-br-md" />
  </>
)
